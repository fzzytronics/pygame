...
def game():
    ...
    try:
        ...
        enemy_ship_image = pygame.image.load(os.path.join(script_dir, "enemies", "enemy_ship.png")).convert_alpha()
    ...
    while running:
        ...
        if not game_over and not victory:
            ...
            dx, dy = enemy_target_pos[0] - enemy_ship_rect.centerx, enemy_target_pos[1] - enemy_ship_rect.centery
            ...
            play_again_label = mono_font.render(" DIES", 1, (255, 255, 255))
